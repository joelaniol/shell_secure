...
# Purpose: parse, normalize, and write Shell-Secure setup configuration files.
# Scope: configuration serialization only; install, runtime state, and menu actions live in sibling setup modules.
